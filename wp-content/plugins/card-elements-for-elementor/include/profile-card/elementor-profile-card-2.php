...
<div class="profile-card-style-2" style="background-image:url(<?php echo $settings['profile_background_image']['url']; ?>);">
    <div class="team-member">
        <div class="team-member-socialmedia team-member-profile">
