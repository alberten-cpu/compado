...
if (!function_exists('card_elements_widget_fail_load')) {
    ...
    function card_elements_widget_fail_load() {
        ...
        if (card_elements_elementor_installed()) {
            ...
            $message = '<p><strong>' . esc_html__('Card Elements for Elementor', CEE_DOMAIN) . '</strong>' . esc_html__(' widgets not working because you need to activate the Elementor plugin.', CEE_DOMAIN) . '</p>';
            $message .= '<p>' . sprintf('<a href="%s" class="button-primary">%s</a>', $activation_url, esc_html__('Activate Elementor Now', CEE_DOMAIN)) . '</p>';
        } else {
            ...
            $message = '<p><strong>' . esc_html__('Card Elements', CEE_DOMAIN) . '</strong>' . esc_html__('widgets are not working because you need to install the Elementor plugin', CEE_DOMAIN) . '</p>';
            $message .= '<p>' . sprintf('<a href="%s" class="button-primary">%s</a>', $install_url, esc_html__('Install Elementor Now', CEE_DOMAIN)) . '</p>';
        }
...
if (!function_exists('card_elements_elementor_update_notice')) {
    ...
    function card_elements_elementor_update_notice() {
        ...
        $message = '<p><strong>' . esc_html__('Card Elements', CEE_DOMAIN) . '</strong>' . esc_html__('widgets are not working because you are using an old version of Elementor.', CTW_DOMAIN) . '</p>';
        $message .= '<p>' . sprintf('<a href="%s" class="button-primary">%s</a>', $upgrade_link, esc_html__('Update Elementor Now', CTW_DOMAIN)) . '</p>';
